...
public partial class Report_Invoice : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        try
        {
         ...
         //   Int64 lngMasterId = Int64.Parse(srtParamval1.ToString());
            ...
            strsql = "select * from Vw_Invoice_Details where invoice_no='" + srtParamval2 + "' and deleted=0 and invoiceflag=1 and Delivery=1";
        ...
        catch (Exception Ex)
        {
            ...
            InsertLogAuditTrail(Session["sesUserID"].ToString(), "PageInit", "Report_Invoice", Ex.ToString(), "Audit");
        }
