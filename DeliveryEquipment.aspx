<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryEquipment.aspx.cs"
    Inherits="DeliveryEquipment" %>
...
<head id="Head1" runat="server">
    ...
    <title>Delivery Equipment</title>
                            ...
                            <div id="Div1" style="height: auto; background: -webkit-linear-gradient(#dbf6e3,Gray);
                                ...
                                <table cellspacing="1" cellpadding="1" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 5%;" align="right">
                                            <asp:Label ID="lblRefNo" Visible="true" runat="server" Text=" Ref No:" />
                                        </td>
                                        <td style="width: 5%;">
                                          <asp:TextBox ID="txtRefNo" Width="150px" runat="server" Enabled="true"></asp:TextBox>
