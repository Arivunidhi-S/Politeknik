...
public partial class Report_JobRejection : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        try
        {
            ...
            string sql = "select CAST(CASE WHEN RejectRemarks = 'Before Calibration' THEN 1 ELSE 0 END AS bit) as BeforeCalibration,CAST(CASE WHEN RejectRemarks = 'During Calibration' THEN 1 ELSE 0 END AS bit)as DuringCalibration,CAST(CASE WHEN RejectRemarks = 'After Calibration' THEN 1 ELSE 0 END AS bit)as AfterCalibration,* from Vw_CRMReceiveEquipmentCustTransDetails where RECEIVED_TRANS_DETAIL_ID='" + srtParamval1.ToString() + "' and  deleted=0";
            ...
            stiReport1.Load(appPath + "\\Reports\\Job_Rejection.mrt");
