<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Calibration.aspx.cs" Inherits="Calibration" %>
                    ...
                    <tr>
                        <td align="left" colspan="2" style="width: 100%;">
                            ...
                            <div id="Div1" style="height: auto; background: -webkit-linear-gradient(#dbf6e3,Gray);
                                ...
                                <table cellspacing="1" cellpadding="1" border="0" width="29%">
                                    <tr>
                                        <td style="width: 18%;">
                                            <br />
                                            ...
                                            <%--<asp:LinkButton ID="LinkButton1" Text="AddNew" runat="server" OnClick="linkAddNew_OnClick"></asp:LinkButton>--%>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <br />
                                            <%-- <asp:TextBox ID="txtowner" Width="150px" runat="server" Enabled="true"></asp:TextBox>--%>
                                        </td>
                                    </tr>
                                </table>
                                <table cellspacing="1" cellpadding="1" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 20%; text-align: left">
                                            ...
                                            <telerik:RadComboBox ID="CboCustomer" runat="server" Height="350px" Width="200px"
                                                AutoPostBack="true" DropDownWidth="300px" EnableLoadOnDemand="true" AppendDataBoundItems="True"
                                                Visible="true" OnItemsRequested="cboCustomer_OnItemsRequested" EmptyMessage="Select Customer Name">
                                                <HeaderTemplate>
                                        ...
                                        <td style="width: 10%;">
                                            <telerik:RadComboBox ID="cboQuotationNo" runat="server" Height="200px" Width="180px"
                                                AutoPostBack="true" DropDownWidth="300px" DataValueField="Quotation_Id" OnItemsRequested="cboQuotation_OnItemsRequested"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblEquipment" Visible="true" runat="server" Text="Equipment :" />
                                        </td>
                                        <td>
                                            <%-- <asp:Label ID="txtequipment" Visible="true" runat="server" />--%>
                                            <asp:TextBox ID="txtequipment" Width="200px" runat="server" Enabled="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblType" Visible="true" runat="server" Text="Type:" />
                                        </td>
                                        <td>
                                            <telerik:RadComboBox ID="cbotype" runat="server" Height="60px" Width="200px" OnSelectedIndexChanged="cbotype_SelectedIndexChanged"
                                                Skin="Hay" AppendDataBoundItems="True" AutoPostBack="true">
                                                <Items>
                                                    <telerik:RadComboBoxItem Text="<--Select-->" ForeColor="Black" />
                                                    <telerik:RadComboBoxItem Text="Accredited" Value="0" />
                                                    <telerik:RadComboBoxItem Text="Non-Accredited" Value="1" />
                                                </Items>
                                            </telerik:RadComboBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblSelFolder" Visible="true" runat="server" Text="Select Folder:" />
                                            <%--Select Folder:--%>
                                        </td>
                                        <td>
                                            <telerik:RadComboBox ID="cbofolder" runat="server" Height="200px" Width="200px" OnItemsRequested="cboFolder_OnItemsRequested"
                                                DropDownWidth="300px" EnableLoadOnDemand="true" AppendDataBoundItems="True" EmptyMessage="Select Folder"
                                                AutoPostBack="true">
                                                <Items>
                                                </Items>
                                            </telerik:RadComboBox>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblselectCalib" Visible="true" runat="server" Text="Select Calibration Sheet:" />
                                        </td>
                                        <td>
                                            <telerik:RadComboBox ID="cboCalibSheet" runat="server" Height="200px" Width="200px"
                                                OnItemsRequested="cboselectCalib_OnItemsRequested" DropDownWidth="300px" EnableLoadOnDemand="true"
                                                AppendDataBoundItems="True" EmptyMessage="Select File" AutoPostBack="true">
                                                <Items>
                                                </Items>
                                            </telerik:RadComboBox>
                                            <asp:Button runat="server" ID="btnCertiDwnld" Font-Size="Smaller" ForeColor="Red"
                                                Text=" " OnClick="btnCalibSheet_Click" CssClass="down" AutoPostBack="true" Width="30px"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblCertificateNo" Visible="true" runat="server" Text="CertificateNo:" />
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtcertno" Width="150px" runat="server" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblStickerNo" Visible="true" runat="server" Text="StickerNo:" />
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtstickno" Width="150px" runat="server" Enabled="true"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Button ID="btnStickerReport" runat="server" Text="  Report  " OnClick="btnStickerReport_Click"
                                                CssClass="button" />
                                            <asp:Button ID="btnReport" runat="server" Text="  DelivaryReport  " OnClick="btnReport_Click"
