<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryEquipmentView.aspx.cs"
    Inherits="DeliveryEquipmentView" %>
...
<head id="Head1" runat="server">
    ...
    <title>Delivery Equipment View</title>
                                        ...
                                        <div id="Div_MIV" runat="server" style="width: 100%; overflow: auto;">
                                            ...
                                            <telerik:RadGrid runat="server" AllowPaging="True" ID="RadGridQuot" OnNeedDataSource="RadGridQuot_NeedDataSource"
                                                ...
                                                <MasterTableView DataKeyNames="RECEIVED_TRANS_DETAIL_ID" ClientDataKeyNames="RECEIVED_TRANS_DETAIL_ID"
                                                    ...
                                                    <Columns>
                                                        <telerik:GridBoundColumn SortExpression="DeliveryNo" HeaderText="Reference No" AllowFiltering="false"
                                                            HeaderButtonType="TextButton" DataField="DeliveryNo" UniqueName="DeliveryNo"
                                                            Visible="true">
