<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quotation_View.aspx.cs" Inherits="Quotation_View" %>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td style="width: 100%; text-align: left;">
                                            ...
                                            <telerik:RadGrid runat="server" AllowPaging="True" ID="RadGrid1" PageSize="30" PagerStyle-AlwaysVisible="true"
                                                ...
                                                <MasterTableView DataKeyNames="Quotation_Trans_ID" ClientDataKeyNames="Quotation_Trans_ID"
                                                    ...
                                                    <Columns>
                                                        <telerik:GridBoundColumn DataField="Quotation_Trans_ID" DataType="System.String"
                                                            HeaderText="Quotation_Trans_ID" SortExpression="Quotation_Trans_ID" UniqueName="Quotation_Trans_ID"
                                                            Visible="false">
                                                        ...
                                                        <telerik:GridBoundColumn DataField="Quotation_Date" DataType="System.DateTime" HeaderText="Quote Date"
                                                            SortExpression="Quotation_Date" UniqueName="Quotation_Date" AllowFiltering="false"
                                                            FilterControlWidth="70px" DataFormatString="{0:dd/MMM/yyyy}">
                                                            <HeaderStyle Width="7%" HorizontalAlign="Center" Font-Names="Arial" />
                                                        ...
                                                        <telerik:GridBoundColumn DataField="Price" DataType="System.String" HeaderText="Price"
                                                            SortExpression="Price" UniqueName="Price" AllowFiltering="false" FilterControlWidth="100px">
                                                            <HeaderStyle Width="5%" HorizontalAlign="Center" Font-Bold="false" Font-Names="Arial"
                                                                Font-Size="12px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="Qty" DataType="System.String" HeaderText="Qty"
                                                            SortExpression="Qty" UniqueName="Qty" AllowFiltering="false" FilterControlWidth="100px">
                                                            <HeaderStyle Width="5%" HorizontalAlign="Center" Font-Bold="false" Font-Names="Arial"
                                                                Font-Size="12px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="Total" DataType="System.String" HeaderText="Total Price"
                                                            SortExpression="Total" UniqueName="Total" AllowFiltering="false" FilterControlWidth="100px">
                                                            <HeaderStyle Width="5%" HorizontalAlign="Center" Font-Bold="false" Font-Names="Arial"
                                                                Font-Size="12px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </telerik:GridBoundColumn>
                                                        <%--<telerik:GridTemplateColumn HeaderText="Total Price" AllowFiltering="false">
                                                            <HeaderStyle Width="5%" HorizontalAlign="Center" Font-Bold="false" Font-Names="Arial" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbltotprice" Text="" Enabled="true" ToolTip="0" runat="server">
                                                                </asp:Label>
                                                            </ItemTemplate>
