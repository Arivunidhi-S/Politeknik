...
public partial class Report_AfterCalibration : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        try
        {
            if (!(string.IsNullOrEmpty(Session["sesUserID"].ToString())))
            {
                ...
                //strsql = "select * from Vw_CRMReceiveEquipmentCustTransDetails_Calib where JOBNO='" + srtParamval1 + "' and RunningNo='" + srtParamval2 + "' and deleted=0 ";

                strsql = "select * from Vw_CRMReceiveEquipmentCustTransDetails where jobno='" + srtParamval1 + "' and DeliveryNo ='" + srtParamval2 + "' and Delivery=1 and Invoiceflag=0  and deleted=0 ";
                ...
                stiReport1.Load(appPath + "\\Reports\\AfterCalib.mrt");
        ...
        catch (Exception Ex)
        {
            ...
            InsertLogAuditTrail(Session["sesUserID"].ToString(), "PageInit", "Report_AfterCalibration", Ex.ToString(), "Audit");
        }
