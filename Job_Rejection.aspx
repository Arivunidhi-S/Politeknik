<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Job_Rejection.aspx.cs" Inherits="Job_Rejection" %>
                    ...
                    <tr>
                        <td align="left" colspan="2" style="width: 100%;">
                            ...
                            <div id="Div1" style="height: auto; background: -webkit-linear-gradient(#dbf6e3,Gray);
                                ...
                                <br />
                                <table border="0px" cellpadding="5" cellspacing="2" width="90%">
                                    <tr>
                                        ...
                                        <td style="width: 15%; text-align: left">
                                            <asp:Label ID="lblInvoicemasterid" Text="" Visible="false" runat="server" />
                                        ...
                                        <td style="width: 35%; text-align: left">
                                            ...
                                            <asp:TextBox Width="100px" ID="txtPOno" MaxLength="5" ToolTip="Maximum Length: 5"
                                                Visible="false" Enabled="True" EmptyMessage="PO NO" TextMode="SingleLine" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left">
                                            <asp:Label ID="Label2" Text="Equipment :" runat="server" Style="color: Black" />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:TextBox Width="200px" ID="txtequipment" MaxLength="500" ToolTip="Maximum Length: 500"
                                                Enabled="false" TextMode="SingleLine" runat="server" Visible="true" Text=""></asp:TextBox>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label3" Text="Maker :" runat="server" Style="color: Black" />
                                            <%-- --------------------------------------------------%>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:TextBox Width="200px" ID="txtMaker" MaxLength="500" ToolTip="Maximum Length: 500"
                                                Enabled="false" TextMode="SingleLine" runat="server" Visible="true" Text=""></asp:TextBox>
                                            <%-- --------------------------------------------------%>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label5" Text="Model :" runat="server" Style="color: Black" />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:TextBox Width="200px" ID="txtModel" MaxLength="500" ToolTip="Maximum Length: 500"
                                                Enabled="false" TextMode="SingleLine" runat="server" Visible="true" Text=""></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadDatePicker ID="dtRejection" runat="server" AutoPostBack="true" Width="100px"
                                                Visible="true" DateInput-EmptyMessage="Date" DbSelectedDate='<%# Bind("Invoice_Date") %>'
                                                DateInput-DateFormat="dd/MMM/yyyy" Skin="Hay">
                                        ...
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label6" Text="To :" runat="server" Style="color: Black" />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:TextBox Width="200px" ID="txtto" MaxLength="500" ToolTip="Maximum Length: 500"
                                                Enabled="true" TextMode="SingleLine" runat="server" Visible="true" Text=""></asp:TextBox>
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:Label ID="Label7" Text="YourRef :" runat="server" Style="color: Black" />
                                        </td>
                                        <td style="text-align: left;">
                                            <asp:TextBox Width="200px" ID="txtref" MaxLength="500" ToolTip="Maximum Length: 500"
                                                Enabled="true" TextMode="SingleLine" runat="server" Visible="true" Text=""></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="cboRejectAt" runat="server" Height="80px" Width="200px"
                                                Skin="Hay" AppendDataBoundItems="True">
                                                <Items>
                                                    <telerik:RadComboBoxItem Text="<--Select-->" ForeColor="Black" />
                                                    <telerik:RadComboBoxItem Text="Before Calibration" Value="0" />
                                                    <telerik:RadComboBoxItem Text="During Calibration" Value="1" />
                                                    <telerik:RadComboBoxItem Text="After Calibration" Value="2" />
                                                </Items>
                                            </telerik:RadComboBox>
                                        </td>
                                        <td>
                                            <asp:Button ID="btnReject" runat="server" Text=" Reject " OnClick="btnIReject_OnClick"
                                                CssClass="button" />
                                        </td>
                                ...
                                <tr>
                                    <td align="left" style="width: 100%;">
                                        <div id="Div2" runat="server" style="width: 100%;">
                                            ...
                                            <telerik:RadGrid runat="server" AllowPaging="True" ID="RadGridRejection" PageSize="20"
                                                PagerStyle-AlwaysVisible="true" OnNeedDataSource="RadGridRejection_NeedDataSource"
                                                Skin="Hay" Width="100%" AllowMultiRowSelection="false" GridLines="Both" ShowFooter="true"
                                                AllowFilteringByColumn="true" OnItemDataBound="RadGridRejection_ItemDataBound"
                                                Visible="true">
                                                <MasterTableView DataKeyNames="Received_Trans_Detail_ID" ClientDataKeyNames="Received_Trans_Detail_ID"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="JobNo" AllowFiltering="false">
                                                            <HeaderStyle Width="10%" Font-Names="Arial" HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbljob" runat="server" Visible="false" Text='<%# Bind("JOBNO") %>'></asp:Label>
                                                                <asp:Label ID="lblrunno" runat="server" Visible="false" Text='<%# Bind("RunningNo") %>'></asp:Label>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="RejectionDate" HeaderText="Rejection Date" SortExpression="RejectionDate"
                                                            UniqueName="RejectionDate" DataFormatString="{0:dd/MMM/yyyy}">
                                                            <HeaderStyle Width="3%" HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="ToReject" HeaderText="To Reject" SortExpression="ToReject"
                                                            UniqueName="ToReject">
                                                            <HeaderStyle Width="3%" HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="YourRef" HeaderText="YourRef" SortExpression="YourRef"
                                                            UniqueName="YourRef">
                                                            <HeaderStyle Width="3%" HorizontalAlign="Left" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </telerik:GridBoundColumn>
