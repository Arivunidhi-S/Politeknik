...
public partial class DeliveryEquipmentView : System.Web.UI.Page
{
    ...
    public DataTable DataSourceHelper()
    {
        ...
        sql = "select * FROM Vw_CRMReceiveEquipmentCustTransDetails WHERE Deleted=0 and Delivery=1 and Invoiceflag=0 order by RECEIVED_TRANS_DETAIL_ID desc";
